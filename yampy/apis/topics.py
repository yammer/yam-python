...
class TopicsAPI(object):
    """
    Provides an interface for accessing the topics related endpoints of the
    Yammer API. You should not instantiate this class directly; use the
    :meth:`yampy.Yammer.topics` method instead.
    """

    def __init__(self, client):
        """
        Initializes a new TopicsAPI that will use the given ``client`` object
